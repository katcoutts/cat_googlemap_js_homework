...
var handleWhereButtonClick = function(){
  navigator.geolocation.getCurrentPosition(function(position){
    map.moveToLocation({lat: position.coords.latitude, lng:position.coords.longitude}, "You are here. Lat: " +  position.coords.latitude + " Lng: " + position.coords.longitude );
  });
}
...
var initialize = function(){
  ...
  map = new Map(container, center, 10);
  ...
  whereButton.onclick = handleWhereButtonClick;
}
